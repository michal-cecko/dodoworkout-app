    ...
    <section id="hp_hero" class="relative px-14 mb-14 -mt-[var(--header-height)] pt-[var(--header-height)] max-lg:px-0"
        ...
        <div class="container-wrapper max-lg:mt-16 max-lg:!max-w-full">
            <div id="hero-swiper" class="relative overflow-hidden max-lg:px-[var(--container-padding)]">
                    ...
                    <div class="swiper-slide">
                        <div class="flex items-center gap-12 relative max-lg:flex-col">
                            <div class="w-1/2 flex flex-col gap-20 max-lg:w-full">
                                <div>
                                    <h2 class="text-5xl uppercase max-w-[586px] max-lg:max-w-full mb-11 hfont max-lg:text-3xl">
                                        {!! __("home_hero_heading") !!}
                                    </h2>
                                    <p class="text-textSecondary text-xl mb-5 pr-20 max-lg:pr-8">
                                        {!! __("home_hero_text") !!}
                                    </p>
                                    <div class="flex ml-2">
                ...
                <div class="hidden absolute bg-primary text-white left-[50%] bottom-[60px] translate-x-[-50%] z-10 flex rounded-xl max-lg:top-[68%] max-lg:translate-y-[-50%] max-lg:bottom-auto">
    ...
    @if($events->isNotEmpty())
        <section class="card-holder gray py-20 relative">
            <div class="container-wrapper mb-12">
                <h4 class="text-primary font-semibold mb-7 max-lg:mb-6">{{__("home_workshops_subheading")}}</h4>
                <div class="flex gap-4 max-lg:flex-col">
                    <h2 class="text-3xl font-bold uppercase max-w-[500px] hfont max-lg:text-3xl">
                        {{__("home_workshops_heading")}}
                    </h2>
