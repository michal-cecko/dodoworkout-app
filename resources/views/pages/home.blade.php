...
@section('body')
    ...
    <section id="hp_hero" class="relative px-14 mb-14 -mt-[var(--header-height)] pt-[var(--header-height)] max-lg:px-0"
             style="min-height: calc(100dvh - var(--header-height));">
        <div class="container-wrapper max-lg:mt-16 max-lg:!max-w-full">
            <div id="hero-swiper" class="relative overflow-hidden max-lg:px-[var(--container-padding)]">
                        ...
                        <div class="flex items-center gap-12 relative max-lg:flex-col">
                            <div class="w-1/2 flex flex-col gap-20 max-lg:w-full">
                                <div>
                                    ...
                                    <div class="flex ml-2">
                                        <a class="btn" data-variant="primary" href="{{LocaleService::getLocalizedRoutePathByName(name: "event", parameters: ['event' => app()->currentLocale() === "sk" ? 'wswcf-academy-2-dnove-skolenie-trenerov-kalisteniky' : "become-a-certified-street-workout-and-calisthenics-trainer"])}}">{!! __("home_certification_slide_button_primary") !!}</a>
                                    </div>
                                </div>
                ...
                <div class="max-md:hidden absolute bg-primary text-white left-[50%] bottom-[60px] translate-x-[-50%] z-10 flex rounded-xl max-lg:top-[68%] max-lg:translate-y-[-50%] max-lg:bottom-auto">
